...
sys.path.insert(0, '/drive1/zhd/finalwork')
...
def get_parser():
    ...
    parser.add_argument('--test_img_dirs', default=r"/drive1/zhd/finalwork/CCPD_dataset/rec/test", help='the test images path')
    ...
    parser.add_argument('--pretrained_model', default=r'/drive1/zhd/finalwork/runs/lprnet-pretrain.pth', help='pretrained base model')
