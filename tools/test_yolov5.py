...
from utils.utils import (
    ...
    non_max_suppression,
    ap_per_class,
    coco80_to_coco91_class,  # 关键：添加这一行（必须包含）
    compute_loss,
    xyxy2xywh,
    xywh2xyxy,
    box_iou,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/drive1/zhd/finalwork/weights/yolov5_best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='/drive1/zhd/finalwork/data/ccpd.yaml', help='*.data path')
    parser.add_argument('--batch-size', type=int, default=16, help='size of each image batch')
    parser.add_argument('--img-size', type=int, default=320, help='demo size (pixels)')
