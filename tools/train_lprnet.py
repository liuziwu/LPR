...
def get_parser():
    ...
    parser.add_argument('--max_epoch', default=600, help='epoch to train the network')
    parser.add_argument('--img_size', default=[94, 24], help='the image size')
    parser.add_argument('--train_img_dirs', default="/drive1/zhd/finalwork/CCPD_dataset/rec/train", help='the train images path')
    parser.add_argument('--test_img_dirs', default="/drive1/zhd/finalwork/CCPD_dataset/rec/val", help='the test images path')
    parser.add_argument('--dropout_rate', default=0.1,type=float, help='dropout rate.')
    parser.add_argument('--learning_rate', default=2e-4, help='base value of learning rate.')
    ...
    parser.add_argument('--lr_schedule', default=[200, 350, 480], help='schedule for learning rate.')
    parser.add_argument('--warmup_epochs', default=10, type=int, help='Warmup epochs (gradually increase LR to base value)')
    parser.add_argument('--save_folder', default='/drive1/zhd/finalwork/runs/',
                        help='Location to save checkpoint models')
    parser.add_argument('--pretrained_model', default='/drive1/zhd/finalwork/runs/lprnet-pretrain.pth', help='no pretrain')
